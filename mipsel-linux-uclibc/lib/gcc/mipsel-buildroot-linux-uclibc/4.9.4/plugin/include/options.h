...
enum opt_code
{
  ...
  OPT_mcode_readable_ = 1079,                /* -mcode-readable= */
  OPT_mdebug = 1080,                         /* -mdebug */
  OPT_mdebugd = 1081,                        /* -mdebugd */
  OPT_mdivide_breaks = 1082,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1083,                  /* -mdivide-traps */
  OPT_mdmx = 1084,                           /* -mdmx */
  OPT_mdouble_float = 1085,                  /* -mdouble-float */
  OPT_mdsp = 1086,                           /* -mdsp */
  OPT_mdspr2 = 1087,                         /* -mdspr2 */
  OPT_meb = 1088,                            /* -meb */
  OPT_mel = 1089,                            /* -mel */
  OPT_membedded_data = 1090,                 /* -membedded-data */
  OPT_meva = 1091,                           /* -meva */
  OPT_mexplicit_relocs = 1092,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1093,                  /* -mextern-sdata */
  OPT_mfix_24k = 1094,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1095,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1096,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1097,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1098,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1099,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1100,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1101,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1102,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1103,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1104,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1105,                 /* -mfp-exceptions */
  OPT_mfp32 = 1106,                          /* -mfp32 */
  OPT_mfp64 = 1107,                          /* -mfp64 */
  OPT_mfused_madd = 1108,                    /* -mfused-madd */
  OPT_mglibc = 1109,                         /* -mglibc */
  OPT_mgp32 = 1110,                          /* -mgp32 */
  OPT_mgp64 = 1111,                          /* -mgp64 */
  OPT_mgpopt = 1112,                         /* -mgpopt */
  OPT_mhard_float = 1113,                    /* -mhard-float */
  OPT_mimadd = 1114,                         /* -mimadd */
  OPT_minterlink_compressed = 1115,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1116,              /* -minterlink-mips16 */
  OPT_mips = 1117,                           /* -mips */
  OPT_mips16 = 1118,                         /* -mips16 */
  OPT_mips3d = 1119,                         /* -mips3d */
  OPT_mllsc = 1120,                          /* -mllsc */
  OPT_mlocal_sdata = 1121,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1122,                    /* -mlong-calls */
  OPT_mlong32 = 1123,                        /* -mlong32 */
  OPT_mlong64 = 1124,                        /* -mlong64 */
  OPT_mmad = 1125,                           /* -mmad */
  OPT_mmcount_ra_address = 1126,             /* -mmcount-ra-address */
  OPT_mmcu = 1127,                           /* -mmcu */
  OPT_mmemcpy = 1128,                        /* -mmemcpy */
  OPT_mmicromips = 1129,                     /* -mmicromips */
  OPT_mmt = 1130,                            /* -mmt */
  OPT_mmusl = 1131,                          /* -mmusl */
  OPT_mnan_ = 1132,                          /* -mnan= */
  OPT_mno_float = 1133,                      /* -mno-float */
  OPT_mno_flush_func = 1134,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1135,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1136,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1137,                     /* -mno-mips3d */
  OPT_mpaired_single = 1138,                 /* -mpaired-single */
  OPT_mplt = 1139,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1140,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1141,               /* -mrelax-pic-calls */
  OPT_mshared = 1142,                        /* -mshared */
  OPT_msingle_float = 1143,                  /* -msingle-float */
  OPT_msmartmips = 1144,                     /* -msmartmips */
  OPT_msoft_float = 1145,                    /* -msoft-float */
  OPT_msplit_addresses = 1146,               /* -msplit-addresses */
  OPT_msym32 = 1147,                         /* -msym32 */
  OPT_msynci = 1148,                         /* -msynci */
  OPT_mtune_ = 1149,                         /* -mtune= */
  OPT_muclibc = 1150,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1151,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1152,                          /* -mvirt */
  OPT_mvr4130_align = 1153,                  /* -mvr4130-align */
  OPT_mxgot = 1154,                          /* -mxgot */
  OPT_n = 1155,                              /* -n */
  OPT_no_canonical_prefixes = 1156,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1157,              /* -no-integrated-cpp */
  OPT_noasmopt = 1158,                       /* -noasmopt */
  ...
  OPT_std_gnu__1y = 1230,                    /* -std=gnu++1y */
  ...
  OPT_time = 1246,                           /* -time */
  OPT_time_ = 1247,                          /* -time= */
  OPT_tno_android_cc = 1248,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1249,                 /* -tno-android-ld */
